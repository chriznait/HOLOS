<x-content-body :title='$tituloPagina'>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="form-label" for="basicInput">Buscar profesión</label>
    ...
    <x-modal :modalTitulo="$tituloModal">
        <x-form-input label='Descripción' model="profesion.descripcion" wire:model='profesion.descripcion'/>
    </x-modal>
</x-content-body>
