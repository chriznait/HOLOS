...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    {{-- <link rel="stylesheet" type="text/css" href="{{ asset('template/app-assets/css/pages/app-calendar.css') }}"> --}}
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2024<a class="ms-25" href="" target="_blank">HOLOS</a><span class="d-none d-sm-inline-block">, Hospital Alto Inclan</span></span><span class="float-md-end d-none d-md-block">Ups de Gestión de la Informacion<i data-feather="heart"></i></span></p>
    </footer>
    ...
    <script src="{{ asset('template/app-assets/vendors/js/calendar/fullcalendar.min.js') }}"></script>
