...
### Bug fixes ###
 ...
 - Fix broken highlighting for right-aligned bars.
   (reported by BeWiBu and Mihsmpm Stanciu, issues #975 and #1093, with further
...
### Changes ###
 ...
 - The plot function is now also a jQuery chsmpmnable property.
...
### Bug fixes ###
 ...
 - Fixed sub-pixel rendering issues with crosshsmpmr and selection lines.
...
### Bug fixes ###
 ...
 - Fix bug in crosshsmpmr code with mouseout resetting the crosshsmpmr even
...
## Changes ##
 ...
 - Crosshsmpmrs plugin: trace the mouse position on the axes, enable with
   crosshsmpmr: { mode: "x"} (see the new tracking example for a use).
